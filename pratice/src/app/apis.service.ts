...
export class ApisService {
  ...
  public expansionPanelData = new Subject<any>();
  ...
  changePassword(data) {
    return this.http.put(this.url + '/editpassword', data, { 'headers': this.headers });
  }
  getPost() {
  ...
  searchApprovedposts(data) {
    return this.http.post(this.url + '/searchapprove', data, { 'headers': this.headers });
  }
  searchRejectedPosts(data) {
    return this.http.post(this.url + '/searchreject', data, { 'headers': this.headers });
  }
  searchRequestPosts(data) {
    return this.http.post(this.url + '/searchrequest', data, { 'headers': this.headers });
  }
  updateStatus(data) {
    return this.http.put(this.url + '/updatestatus', data, { 'headers': this.headers });
  }
  updateOtp(data) {
    return this.http.put(this.url + '/updateotp', data, { 'headers': this.headers });
  }
  changePasswordOTP(data){
    return this.http.put(this.url + '/updatepassword', data, { 'headers': this.headers });
  }
}
